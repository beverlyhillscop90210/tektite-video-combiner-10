...
2. Restart ComfyUI
3. Add node: `Tektite Video Combiner 10.0`

## Notes
- This package intentionally uses a different backend class (`TektiteVideoCombiner10`) so it can live next to older versions.
